// select dom element 
// const addCounterElm = document.getElementById("add-counter");
...
//         return{
//             ...state,
//             counters: state.counters.map((counter)=> counter.id === action.payload.id) ? {...counter, value: counter.value + counter.increaseBy} : {...counter}
//         }
